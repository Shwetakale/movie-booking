...
movie_screen = MovieScreen.create(screen: screen1, movie: movie1, slot: slot1, start_time: "#{Date.today + 2.days} #{slot1.start_time}")
movie_screen = MovieScreen.create(screen: screen2, movie: movie1, slot: slot2, start_time: "#{Date.today + 3.days} #{slot2.start_time}")
movie_screen = MovieScreen.create(screen: screen2, movie: movie1, slot: slot3, start_time: "#{Date.today + 1.day} #{slot3.start_time}")
